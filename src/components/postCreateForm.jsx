...
// custom imports
import { missingPostScheme } from '../constants/postSchema';
...
const CreatePostForm = ({ handleSubmitPost, photo, setPhoto, isLoading }) => {
	const {
		control,
		// setError,
		handleSubmit,
	...
	return (
		...
		>
			...
			<Button
				...
				sx={{ mt: 2 }}
			>
				{isLoading ? <CircularProgress size={29} color='dark' /> : 'Submit'}
			</Button>
		</form>
	);
};
